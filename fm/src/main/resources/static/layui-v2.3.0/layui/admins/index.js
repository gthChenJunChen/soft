...
;layui.extend({setter: "config", admin: "admin", view: "view"}).define(["setter", "admin"], function (e) {
    var a = layui.setter, n = layui.element,
        i = layui.admin, t = i.tabsPage, l = layui.view,
        o = function () {
        ...
        r = function (e) {
            ...
            if (layui.each(a.indPage, function (e, a) {
                    if (s === a) return n = !0
                }), layui.config({base: a.base}), n || "/user/login" === s)    //+ "controller/"
